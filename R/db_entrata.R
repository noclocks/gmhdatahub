...
db_upsert_entrata_pre_lease_report_by_unit <- function(pool, data_lst) {
  ...
  db_upsert_entrata_pre_lease_summary_by_property_unit(pool, summary_tbl)
  db_upsert_entrata_pre_lease_details_by_property(pool, details_tbl)
  db_upsert_entrata_report_execution(pool, execution_details_tbl)
...
db_upsert_entrata_pre_lease_summary_by_property_unit <- function(pool, summary_data) {
