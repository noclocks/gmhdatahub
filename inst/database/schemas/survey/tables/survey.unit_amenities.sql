DROP TABLE IF EXISTS survey.unit_amenities CASCADE;

CREATE TABLE survey.unit_amenities (
  ...
  amenity_value BOOLEAN NOT NULL,
  amenity_varies BOOLEAN NOT NULL DEFAULT FALSE,
