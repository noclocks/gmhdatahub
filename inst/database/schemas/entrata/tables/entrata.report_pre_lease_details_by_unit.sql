DROP TABLE IF EXISTS entrata.report_pre_lease_details_by_unit CASCADE;

CREATE TABLE entrata.report_pre_lease_details_by_unit (
...
CREATE INDEX idx_report_pre_lease_details_by_unit_report_date ON entrata.report_pre_lease_details_by_unit (report_date);
